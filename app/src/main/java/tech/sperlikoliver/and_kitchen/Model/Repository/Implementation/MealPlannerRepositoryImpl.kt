...
class MealPlannerRepositoryImpl : IMealPlannerRepository {
    ...
    override fun getMealPlanner() {
        ...
        mealPlannerRef.whereEqualTo("userId", FirebaseAuth.getInstance().currentUser?.uid).get().addOnCompleteListener(){mealPlannerSnapshot ->
    ...
    override fun getMealPlannerEntry(mealPlannerEntryId: String) {
        ...
        mealPlannerRef.document(mealPlannerEntryId).get().addOnCompleteListener(){ mealPlannerEntrySnapshot ->
